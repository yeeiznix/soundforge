# SoundForge G0 — Python schema/migration tests (docs/PLAN_G0.md §7.3).
...
# Make the G0 source package importable without installing it.
...
def test_validate_minimal_v1():
    assert validate_project(_load("project_minimal_v1.json")) == []
